...
import { Button, Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DialogTrigger, DropdownMenu, DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuTrigger, Input, Label, Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@nx-next-shadcn/shadcn";
import {
  ColumnDef,
  ColumnFiltersState,
  SortingState,
            ...
            <div className="flex items-center justify-end space-x-2 py-4">
                ...
                <div className="space-x-2">
                    ...
                    <Button
                        ...
                        size="sm"
                        onClick={() => {
                            setPageIndex((old) => Math.min(table.getPageCount() - 1, old + 1));
                        }}
